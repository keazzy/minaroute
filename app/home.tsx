...
import { CATEGORIES, Location } from '@/constants/mockData';
...
// Assets from Figma
const ASSETS = {
  avatar: "https://www.figma.com/api/mcp/asset/41add518-5ebf-4aac-adc1-6b9fed30a555",
  avatarHead: "https://www.figma.com/api/mcp/asset/83518b1b-8fb5-4f11-ba32-473d50999fc3",
  mosqueImage: "https://www.figma.com/api/mcp/asset/c6924865-48b4-489b-b788-4039fdc54d3b",
  schoolImage: "https://www.figma.com/api/mcp/asset/716aa287-2d7f-4db6-baec-a435909368f2",
};
...
export default function HomeScreen() {
  ...
  const placeDetailsSheetRef = useRef<BottomSheetModal>(null);
  const eventDetailsSheetRef = useRef<BottomSheetModal>(null);
  const submitPlaceSheetRef = useRef<BottomSheetModal>(null);
  ...
  const snapPoints = useMemo(() => {
    const collapsed = Math.max(280, windowHeight * 0.35);
  ...
  const renderHomeBackdrop = useCallback(
    (props: any) => (
      <BottomSheetBackdrop
        {...props}
        appearsOnIndex={1}
    ...
    return (
      <View>
        <View style={styles.greetingContainer}>
           <Text style={styles.greetingText}>As-salaam alaykum, Arowolo 👋</Text>
           <Text style={styles.subGreetingText}>Find nearest mosque, halal food</Text>
        </View>
        ...
        <View style={styles.locationsHeaderContainer}>
          <Text style={styles.locationsHeader}>Nearby</Text>
        </View>
      </View>
    );
  }, [renderCategoryItem]);
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <View style={[styles.headerContainer, { top: insets.top + 10 }]}>
        <View style={styles.headerContent}>
          <View style={styles.avatarContainer}>
            <View style={styles.avatarWrapper}>
              <Image source={{ uri: ASSETS.avatar }} style={styles.avatarCollar} />
              <Image source={{ uri: ASSETS.avatarHead }} style={styles.avatarHead} />
            </View>
          </View>
          <TouchableOpacity
        ...
        {__DEV__ && (
          <TouchableOpacity
            ...
            onPress={() => {
              void Storage.deleteItemAsync('onboarding_seen_v1');
              void Storage.deleteItemAsync('location_permission_skip_v1');
      ...
      <BottomSheetModal
        ...
        backdropComponent={renderHomeBackdrop}
      ...
      >
        <BottomSheetFlatList<HomeListItem>
          ...
          renderItem={({ item }: { item: HomeListItem }) => (
            <View style={{ marginBottom: 12 }}>{renderLocationItem({ item })}</View>
          )}
      ...
      >
        <BottomSheetScrollView
          contentContainerStyle={[
            styles.submitPlaceSheetContent,
          ...
          nestedScrollEnabled
        >
          <View style={styles.submitPlaceHeader}>
            <Text style={styles.submitPlaceTitle}>Submit a place</Text>
            <Text style={styles.submitPlaceSubtitle}>
              We are building a directory for all muslims and your help would go a long way
            </Text>
          </View>

          <View style={styles.submitPlaceImageWrap}>
            <Image source={{ uri: 'https://www.figma.com/api/mcp/asset/01f62de1-71cd-4e8e-b336-b1d71a397edd' }} style={styles.submitPlaceImage} />
          </View>

          <View style={styles.submitPlaceSectionHeader}>
            <Text style={styles.submitPlaceSectionTitle}>How to Submit a Place</Text>
          </View>

          <View style={styles.submitPlaceSteps}>
            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>1</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Click the submit place button</Text>
                <Text style={styles.submitPlaceStepSubtitle}>This starts the process of submission</Text>
              </View>
            </View>

            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>2</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Enter the name of the place</Text>
                <Text style={styles.submitPlaceStepSubtitle}>If available this would help people find the places or event easily.</Text>
              </View>
            </View>

            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>3</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Select a category</Text>
                <Text style={styles.submitPlaceStepSubtitle}>Helps us to categorize your submission correctly</Text>
              </View>
            </View>

            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>4</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Add a description if available</Text>
                <Text style={styles.submitPlaceStepSubtitle}>Optional, but helps others learn more about the place or event</Text>
              </View>
            </View>

            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>5</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Add photos</Text>
                <Text style={styles.submitPlaceStepSubtitle}>Upload photos of the place or event.</Text>
              </View>
            </View>

            <View style={styles.submitPlaceStepRow}>
              <View style={styles.submitPlaceStepBadge}>
                <Text style={styles.submitPlaceStepBadgeText}>6</Text>
              </View>
              <View style={styles.submitPlaceStepTextWrap}>
                <Text style={styles.submitPlaceStepTitle}>Provide tags relevant to the place</Text>
                <Text style={styles.submitPlaceStepSubtitle}>These help others find what they are looking for.</Text>
              </View>
            </View>
          </View>

          <View style={styles.submitPlaceButtonContainer}>
            <TouchableOpacity style={styles.submitPlaceButton} onPress={handleSubmitPlacePress} activeOpacity={0.9}>
              <Text style={styles.submitPlaceButtonText}>Submit place</Text>
            </TouchableOpacity>
          </View>
        </BottomSheetScrollView>
      </BottomSheetModal>
